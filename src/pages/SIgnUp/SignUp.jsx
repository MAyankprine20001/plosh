...
const SignUp = () => {
  ...
  const validationSchema = yup.object({
    ...
    phone: yup
      ...
      .test('is-numeric', 'Phone number must not contain letters', function(value) {
        if(value) {
          return /^\d+$/.test(value); // Check if value contains only digits
        }
        return false; // If value is empty, consider it invalid
      })
              ...
              <div style={{ color: "red" }}>
                ...
                {formik.values.password && (
                  <>
                    ...
                    {/* {formik.values.password.length > 0 && formik.values.password.length <= 8 && 'Please enter at least 8 characters'} */}
